...
const contactUs = document.querySelector('a[href^="#form-section"]');
const aboutUsFooter = document.getElementById('my-work');
...
const hostelFacilityFootermob = document.getElementById(
  'hostel-faility-footer-mob'
);
...
hostelFacilityFooter.addEventListener('click', (e) => {
  ...
  const target = document.querySelector(
    hostelFacilityFooter.getAttribute('href')
  );
...
hostelFacilityFootermob.addEventListener('click', (e) => {
  ...
  const target = document.querySelector(
    hostelFacilityFootermob.getAttribute('href')
  );
...
testimonialFootermob.addEventListener('click', (e) => {
  ...
  const target = document.querySelector(
    testimonialFootermob.getAttribute('href')
  );
...
contactUsFootermob.addEventListener('click', (e) => {
  ...
  const target = document.querySelector(
    contactUsFootermob.getAttribute('href')
  );
...
const images = ['first-client.png', 'second-client.png', 'third-client.png'];
...
const names = ['Sunil Shetti', 'Sunil Shetti1', 'Sunil Shetti2'];
